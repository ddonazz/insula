...
import it.andrea.insula.owner.internal.owner.dto.request.BusinessOwnerUpdateDto;
...
@Component
public class BusinessOwnerUpdateMapper implements BiFunction<BusinessOwnerUpdateDto, BusinessOwner, BusinessOwner> {

    @Override
    public BusinessOwner apply(BusinessOwnerUpdateDto dto, BusinessOwner owner) {
