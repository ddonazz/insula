...
public class AgreementPatchMapper implements BiFunction<AgreementPatchDto, ManagementAgreement, ManagementAgreement> {
    ...
    public ManagementAgreement apply(AgreementPatchDto dto, ManagementAgreement agreement) {
        ...
        if (dto.financialTerms() != null) {
            ...
            if (dto.financialTerms().commissionPercentage() != null) ft.setCommissionPercentage(dto.financialTerms().commissionPercentage());
            if (dto.financialTerms().vatOnCommission() != null) ft.setVatOnCommission(dto.financialTerms().vatOnCommission());
            if (dto.financialTerms().fixedMonthlyAmount() != null) ft.setFixedMonthlyAmount(dto.financialTerms().fixedMonthlyAmount());
            ...
            if (dto.financialTerms().paymentDelayDays() != null) ft.setPaymentDelayDays(dto.financialTerms().paymentDelayDays());
        ...
        if (dto.operationalTerms() != null) {
            ...
            if (dto.operationalTerms().maintenanceAuthThreshold() != null) ot.setMaintenanceAuthThreshold(dto.operationalTerms().maintenanceAuthThreshold());
            if (dto.operationalTerms().cancellationNoticeDays() != null) ot.setCancellationNoticeDays(dto.operationalTerms().cancellationNoticeDays());
            if (dto.operationalTerms().autoRenewal() != null) ot.setAutoRenewal(dto.operationalTerms().autoRenewal());
            if (dto.operationalTerms().internalNotes() != null) ot.setInternalNotes(dto.operationalTerms().internalNotes());
