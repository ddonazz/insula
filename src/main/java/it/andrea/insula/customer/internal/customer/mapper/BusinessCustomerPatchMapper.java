...
import it.andrea.insula.customer.internal.address.mapper.AddressPatchMapper;
...
public class BusinessCustomerPatchMapper implements BiFunction<BusinessCustomerUpdateDto, BusinessCustomer, BusinessCustomer> {
